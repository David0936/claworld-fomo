<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/version-0.4.1-606AF7" alt="Version 0.4.1">
...
| 价格止损 | 相对模拟买入价下跌达到20% | 立即模拟清仓并转入“过往监测” |
...
任何模型只使用当时已经记录的数据，不用之后行情倒填此前未观察到的成交。Fomo 占比确认低于15%或价格达到20%止损线时，会按规则清仓全部剩余模拟仓位。

新候选先进入一轮待确认，不立即作为模拟买点。下一独立扫描仍满足市值、年龄与 Fomo 条件，且价格不高于首次候选价时，才登记模拟买入；连续三轮都在首次候选价上方则放弃，减少追在短时冲高位置的情况。这是入场质量过滤，无法证明或预测市场最高点。
