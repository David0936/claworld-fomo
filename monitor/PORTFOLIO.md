...
最新首次命中的标的在主清单高亮为“最新入选 · 当前规则观察点”，只表示它是最新通过规则的观测，不是确定买入建议。首次 `watch_eligible:false` 标记“可能移出 1/3轮”；连续第二轮仍不符合显示 2/3轮；连续第三轮仍不符合后从主清单隐藏。任意一轮重新符合会把计数清零。隐藏只停止主清单展示与重点筛选，不删除 SQLite 样本、事件或 Markdown 档案。
